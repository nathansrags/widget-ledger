...
public final class SecureIdGeneratorService {
	...
	public static void main(String[] args) {
		...
		// log("- Generated UUID : " +
		// crunchifyUUID.generateUniqueKeyUsingUUID());
	...
	public static String generateUID() {
		UUID uuid = UUID.randomUUID();
		return Long.toString(uuid.getMostSignificantBits(), 36).replace("-", "").toUpperCase();
	}
	...
	public UID generateUniqueKeyUsingUID() {
		// UID that is unique over time with respect to the host that it was
		// generated on
	...
	public void generateUniqueKeyUsingMessageDigest() {
		try {
			...
			// Provides applications the functionality of a message digest
			// algorithm, such as MD5 or SHA
